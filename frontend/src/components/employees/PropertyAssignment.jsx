  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid gap-2 max-h-64 overflow-y-auto border rounded-lg p-2">
        {properties.length === 0 ? (
          <div className="text-center py-4 text-gray-500">No properties available</div>
        ) : (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className="font-medium text-gray-800 truncate">{property.name}</span>
                  <span className={`px-2 py-0.5 text-xs rounded-full ${propertyTypeColors[property.propertyType] || 'bg-gray-100 text-gray-800'}`}>
