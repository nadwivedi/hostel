      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="bg-gray-100">
            <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-semibold text-gray-700 border-b">
              Resource
            </th>
            <th className="px-2 sm:px-4 py-2 sm:py-3 text-center font-semibold text-gray-700 border-b">
              All
            </th>
            {actions.map(action => (
              <th key={action} className="px-2 sm:px-4 py-2 sm:py-3 text-center font-semibold text-gray-700 border-b capitalize">
                {action}
              </th>
            ))}
          </tr>
            ...
            <tr key={resource.key} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
              ...
              <td className="px-2 sm:px-4 py-2 sm:py-3 text-center border-b">
                <input
                  ...
                  disabled={disabled}
                  className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 cursor-pointer disabled:cursor-not-allowed"
                />
              </td>
              {actions.map(action => (
                <td key={action} className="px-2 sm:px-4 py-2 sm:py-3 text-center border-b">
                  <input
                    type="checkbox"
