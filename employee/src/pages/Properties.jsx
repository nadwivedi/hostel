...
function Properties() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {/* Welcome Header */}
      <div className="bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl p-4 sm:p-6 text-white">
        <h1 className="text-xl sm:text-2xl font-bold">Welcome, {employee?.fullName}!</h1>
        <p className="text-teal-100 mt-1 text-sm sm:text-base">Select a property to view rooms and add tenants</p>
      </div>
      ...
      {loading ? (
          ...
          {properties.map((property) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 hover:border-teal-300 cursor-pointer hover:scale-[1.02] transform group"
              >
                {/* Property Image */}
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-700 mb-2">No Properties Assigned</h3>
