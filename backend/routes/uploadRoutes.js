...
const { uploadAadhar, uploadDocument, uploadPhoto, uploadProperty } = require('../config/multer');
const {
  uploadAadharImage,
...
router.post('/document', protect, uploadDocument.single('document'), uploadTenantDocument);
